...
if (!isset($_SESSION['usernam'])) {
 ...
 if(isset($_GET['edit_product'])){
    ...
    $get_p = "select * from intellectuelles where id='$edit_id'";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Intellectuelles</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">الصفحة الرئيسية</a></li>
                            <li class="breadcrumb-item active">Intellectuelles</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">

                            تحديث مقالات لأنشطة الفكرية 
                ...
                <div class="col-lg-12 mb-4">
                    ...
                    <?php 
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $update_product = "update intellectuelles set titel='$arTitle',description='$arContent',
