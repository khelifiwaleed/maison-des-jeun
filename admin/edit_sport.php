...
if (!isset($_SESSION['usernam'])) {
 ...
 if(isset($_GET['edit_product'])){
    ...
    $get_p = "select * from sport where id='$edit_id'";
    ...
    $type_category = $row_edit['type_category'];
                ...
                <div class="col-lg-12 mb-4">
                    ...
                    <form type="submit" name="submit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select" name="arCategory" id="arCategory">
                                <option value="<?php echo $type_category; ?>"> <?php echo $type_category; ?> </option>

                             
                                    <option value="كرة القدم">كرة القدم</option>
                                    <option value="كرة السلة">كرة السلة</option>
                                    <option value="كرة الطاولة">كرة الطاولة</option>
                                    <option value="التكواندو">التكواندو</option>
                                    <option value="بريك دانسينج">بريك دانسينج</option>
                    ...
                    <?php 
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $update_product = "update sport set nom='$arTitle',description='$arContent',
                            image='$arImage',type_category='$sous_categorie' where id='$p_id'";
