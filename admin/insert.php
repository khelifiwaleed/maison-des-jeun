...
if ($conn) {
    ...
    if (isset($_POST["submit"])) {
        ...
        switch ($type) {
            case "sport":
                // Upload Image
                uploadImage2("arImage", "../sport/");

                // PREPARE DATA TO INSERT INTO DB
                $data = array(
                    "nom" => test_input($_POST["arTitle"]),
                    "description" => $_POST["arContent"],
                    "image" => test_input($_FILES["arImage"]["name"]),
                    //"type_category" => $_POST["arCategory"],
                    "id_category" => test_input($_POST["arCategory"]),
...
function uploadImage2($name, $dest)
{
    ...
    // Check file size
    if ($_FILES[$name]["size"] > 5000000000) {
