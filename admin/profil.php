...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Maison de Jeunes</a>
            <!-- Sidebar Toggle-->
...
$get_pro = "select * from sport ORDER BY id DESC";
...
<td><img src="../sport/<?php echo $pro_image; ?>" width="60" height="60"></td>

<td> <?php echo $type_category; ?> </td>

<td>

<a href="delete_sport.php?delete_product=<?php echo $pro_id; ?>">
...
<a href="edit_sport.php?edit_product=<?php echo $pro_id; ?>">
...
<a href="delete_culture.php?delete_product=<?php echo $pro_id; ?>">
...
<a href="edit_culture.php?edit_product=<?php echo $pro_id; ?>">
...
$get_pro = "select * from intellectuelles ORDER BY id DESC";
...
<a href="delete_intelect.php?delete_product=<?php echo $pro_id; ?>">
...
<a href="edit_intelect.php?edit_product=<?php echo $pro_id; ?>">
...
<a href="delete_news.php?delete_product=<?php echo $pro_id; ?>">
...
<a href="edit_news.php?edit_product=<?php echo $pro_id; ?>">
