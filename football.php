    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">كرة القدم</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="index.php">الصفحه الرئيسيه</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">كرة القدم</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    $get_pro = "select * from sport WHERE type_category ='كرة القدم'";
                        ...
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="view_sport.php?id=<?php echo $pro_id ; ?>&&cat=<?php echo $pro_categorie ; ?>"><?php echo $pro_title ; ?></a>
                                </div>
                            </div>
                        </div>
                <?php } ?>
