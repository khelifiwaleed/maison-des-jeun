<div class="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5" style="margin-top: 90px;">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="" class="navbar-brand">
                    <h1 class="text-primary"><span class="text-white">دار شباب الرقاب</span></h1>
                </a>
                <p>مشاركة دار الشباب الرقاب في كل الأنشطة الرياضية و الفكرية على مدار العام</p>
                <h6 class="text-white text-uppercase mt-4 mb-3" style="">تابعنا</h6>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <h5 class="text-white text-uppercase mb-4" style="">خدماتنا</h5>
            ...
            <h5 class = "text-white text-uppercase mb-4" style = "letter-spacing: 5px؛"> اتصل بنا </h5>
                 ...
                 <div class = "w-100">
                    <div class="input-group">
                        <input type="text" class="form-control border-light" style="padding: 25px;" placeholder="بريدك الالكتروني">
                        <div class="input-group-append">
                            <button class="btn btn-primary px-3">اشتراك</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style="border-color: rgba(256, 256, 256, .1) !important;">
        <div class="row">
            ...
            <p class = "m-0 text-white-50"> حقوق النشر والنسخ ؛ <a href="#"> المجال </a>. جميع الحقوق محفوظة. </a>
                 </p>
            </div>
