    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">كرة الطاولة</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="index.php">الصفحه الرئيسيه</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">كرة الطاولة</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase" style="">كرة الطاولة</h6>
                <h1>باقات برامج كرة الطاولة</h1>
            </div>
            <div class="row">
                                <?php

                    $get_pro = "select * from sport WHERE type_category ='كرة الطاولة'";
                ...
                <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="view_pingpong.php?id=<?php echo $pro_id ; ?>"><?php echo $pro_title ; ?></a>
                                </div>
                            </div>
                        </div>
                <?php } ?>
